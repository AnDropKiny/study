...
const modals = () => {
  ...
  function openModalByTimer(selector, timeInSec) {
    setTimeout(() => {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
const tabs = function (tabSelector, contentSelector, activeClass) {
...
const timer = (id, deadline) => {
  function getTimeRemaining(deadline) {
    ...
    let t = Date.parse(deadline) - Date.parse(new Date()) - 10800000;
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".glazing_block", ".glazing_content", "active");
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".no_click", ".decoration_content_block", "after_click");
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_3__["default"])(".balcon_icons_img", ".big_img > img", "do_image_more", "inline-block");
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_4__["default"])('.container1', "2022-09-30");

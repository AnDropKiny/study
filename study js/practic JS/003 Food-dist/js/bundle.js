...
function forms(formSelector, modalTimerId) {
  ...
  function showThxModal(message) {
    ...
    thxModal.innerHTML = `<div class="modal__content">
...
function menuCards() {
  ...
  class ItemsMenu {
    constructor(img, altimg, name, description, price) {
      this.name = name;
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_0__.getData)("http://localhost:3000/menu").then(data => data.forEach(_ref => {
    let {
      img,
      altimg,
      title,
...
window.addEventListener("load", () => {
  let modalTimerId = setTimeout(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_4__["default"])('.modal', modalTimerId), 300000);
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_7__["default"])('.timer', '2022-09-30');
});
}();
/******/ })()
;
